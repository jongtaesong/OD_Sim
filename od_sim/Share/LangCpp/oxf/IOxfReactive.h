...
class RP_FRAMEWORK_DLL IOxfReactive : public IOxfEventSender {
public :
    ...
    virtual void endBehavior(const Rhp_const_char_pt /*theTerminator*/ = 0) = 0;
...
protected :
    ...
    virtual IOxfTimeout* scheduleTimeout(OxfTimeUnit delay, const Rhp_const_char_pt targetStateName) = 0;
...
public :
    ...
    //## auto_generated
    virtual IOxfEvent* getCurrentEvent(void) const = 0;
