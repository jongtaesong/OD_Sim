...
public :
    ...
    static const Rhp_int64_t DefaultMessageQueueSize;		//## attribute DefaultMessageQueueSize
    
    // The default thread stack-size
    static const Rhp_int64_t DefaultStackSize;		//## attribute DefaultStackSize
    
    // The default thread priority
    static const Rhp_int64_t DefaultThreadPriority;		//## attribute DefaultThreadPriority
...
public :
    ...
    // Argument const Rhp_int64_t messageQueueSize = OMOSThread::DefaultMessageQueueSize :
    // The initial size of the message queue (number of messages)
    //## operation createOMOSMessageQueue(bool,Rhp_int64_t) const
    virtual OMOSMessageQueue* createOMOSMessageQueue(const bool shouldGrow = true, const Rhp_int64_t messageQueueSize
...
, const Rhp_uint64_t maxCount = 1U, const Rhp_const_char_pt name = NULL) const = 0;
    ...
    // The thread name
    // Argument const Rhp_int64_t stackSize = OMOSThread::DefaultStackSize :
    // The thread stack size
    //## operation createOMOSThread(void (*)(void*),void *,const Rhp_const_char_pt ,Rhp_int64_t) const
    virtual OMOSThread* createOMOSThread(void (*entryFunction)(void*), void * param, const Rhp_const_char_pt threadName
 = NULL, const Rhp_int64_t stackSize = OMOSThread::DefaultStackSize) const = 0;
